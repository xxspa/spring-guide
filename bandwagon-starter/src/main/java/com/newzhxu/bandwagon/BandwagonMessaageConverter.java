...
@Slf4j
public class BandwagonMessaageConverter extends MappingJackson2HttpMessageConverter {
    @Override
    ...
    @Override
    @Nonnull
    public Object read(@NonNull Type type, @Nullable Class<?> contextClass, @NonNull HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
